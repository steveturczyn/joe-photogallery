def log_in
  ...
  bing = Fabricate(:picture, title: "Bing", category_id: cherries.id, represents_user: cherries.user, represents_category: cherries, id: 1)
  dark_hudson = Fabricate(:picture, title: "Dark Hudson", category_id: cherries.id, represents_user: nil, represents_category: nil, id: 2)
  bananas = Fabricate(:category, name: "Bananas", user: charlie)
  chiquita = Fabricate(:picture, title: "Chiquita", category_id: bananas.id, represents_user: nil, represents_category: bananas)
