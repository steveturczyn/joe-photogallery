...
describe WelcomesController do
  describe 'GET index' do
    ...
    let!(:apple) {Fabricate(:picture, title: "Apple", category: fruits1, represent_user: true)}
    let!(:banana) {Fabricate(:picture, title: "Banana", category: fruits2, represent_user: true)}
    let!(:cheetah) {Fabricate(:picture, title: "Cheetah", category: wildlife, represent_user: true)}
